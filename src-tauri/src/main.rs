...
mod tests {
    ...
    fn test_different_inputs_produce_different_keys_and_mnemonics() {
        ...
        let (private_key1, mnemonic1) =
            generate_values(input1.0.clone(), input1.1.clone(), input1.2.clone());
        let (private_key2, mnemonic2) =
            generate_values(input2.0.clone(), input2.1.clone(), input2.2.clone());
    ...
    fn test_same_input_produces_same_key_and_mnemonic() {
        ...
        let (private_key1, mnemonic1) =
            generate_values(input.0.clone(), input.1.clone(), input.2.clone());
        let (private_key2, mnemonic2) =
            generate_values(input.0.clone(), input.1.clone(), input.2.clone());
